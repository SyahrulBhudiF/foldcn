...
export const progressIndicatorClass = 'cn-progress-indicator h-full transition-all'

export const progressLabelClass = 'cn-progress-label'

export const progressValueClass = 'cn-progress-value'
